...
const RevenueModel: React.FC = () => {
    return (
        <div className="bg-cards bg-[url('/3Tokens/white-circle.png')] bg-no-repeat inset-0 px-5 md:px-14 text-white">
            ...
            <div className="w-full md:w-[80%] mt-6 text-center mx-auto">
            ...
            <div className="flex flex-col md:flex-row justify-center items-center gap-7 pt-20">
                {/* Card 1 */}
